...
export const enemyArchetypes: GameContent['enemyArchetypes'] = {
    ...
    pebble: {
      ...
      name: 'Pebble',
      behavior: 'pebble',
      description: 'A giant tunneling worm boss that slithers through defenders, stacking crush trauma while it tunnels toward the sauna.',
      lore: 'Named Pebble by someone who had never seen a pebble before, or what repeated crush waves do to morale.',
      maxHp: 260,
      damage: 18,
      range: 1,
